...
#     cost1 = costs_[0]
#     cost2 = costs_[1]
#     a1 = [0.01, 0.0095, 0.01005]
#     a2 = [0.02, 0.0196, 0.0204]
...
---* to obtain p* list in problem statement, set A[4, 3] = -5500, and A[4, 4] = -6100
---* which is in correct since it is not taking into account the operating costs of drug1 and drug2
---*
"""
cost1 = 700
cost2 = 800
A = np.array([[-0.01, -0.02, 0.5, 0.6],
              ...
              [100.0, 199.9, cost1, cost2]])
b = np.array([0, 1000, 2000, 800, 100000])
c = np.array([100, 199.9,  - 5500,  - 6100])
...
print('original module 2 formulation with error:')
